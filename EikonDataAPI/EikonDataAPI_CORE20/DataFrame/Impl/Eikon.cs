...
namespace EikonDataAPI
{
    ...
    {
        public DataFrame GetData(IEnumerable<string> instruments, IEnumerable<TRField> fields, Dictionary<string, string> parameters = null)
        {
            return DataGrid.GetData(instruments, fields, parameters);
        }

        public DataFrame GetData(IEnumerable<string> instruments, IEnumerable<string> fields, Dictionary<string, string> parameters = null)
        {
            return DataGrid.GetData(instruments, fields, parameters);
        }

        public DataFrame GetData(string instrument, IEnumerable<TRField> fields, Dictionary<string, string> parameters = null)
        {
            return DataGrid.GetData(instrument, fields, parameters);
        }

        public DataFrame GetData(string instrument, string field, Dictionary<string, string> parameters = null)
        {
